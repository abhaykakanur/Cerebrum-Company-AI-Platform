...
| 8000 | Backend (FastAPI)  | HTTP API — `infrastructure/docker/docker-compose.apps.yml` | `BACKEND_PORT`                   |
| 3000 | Frontend (Next.js) | HTTP — `infrastructure/docker/docker-compose.apps.yml`     | (fixed; not yet env-overridable) |
